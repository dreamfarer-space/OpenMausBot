                ...
                Row(horizontalArrangement = Arrangement.spacedBy(10.dp)) {
                    if (runtime != null) {
                        Text(
                            ...
                            color = when (runtime) {
                                stringResource(R.string.mobile_waiting_on_you_edab5b72) -> MaterialTheme.colorScheme.error
                                stringResource(R.string.mobile_waiting_on_teammate_158d309b) -> secondaryTint
                                stringResource(R.string.mobile_queued_6a599877) -> secondaryTint
